...
from PyQt6.QtCore import pyqtSignal, QSettings, QTimer, Qt
...
class SettingsDialog(MagneticDialog):
    ...
    log_window_requested = pyqtSignal()
    ...
    DEFAULT_SETTINGS = {
        ...
        "fw_live_beam_size": 5,
        "fw_live_best_of": 1,
        "fw_live_compression_ratio_threshold": 2.0,
        ...
        "fw_file_beam_size": 5,
        "fw_file_best_of": 1,
        "fw_file_compression_ratio_threshold": 2.0,
    ...
    def _create_transcriber_tab(self) -> QWidget:
        ...
        self.spin_vad_threshold.setRange(0.001, 0.5)  # Increased range for flexibility
        self.spin_vad_threshold.setSingleStep(0.005)
        ...
        self.spin_silence_duration.setSingleStep(0.1)
    ...
    def _create_fw_live_params_tab(self) -> QWidget:
        ...
        pp_form.addRow(self.chk_enable_pp)
        ...
        self.spin_live_wordtimestamp_offset.setSingleStep(0.05)
        ...
        self.spin_live_pad_before.setSingleStep(0.05)
        ...
        self.spin_live_pad_after.setSingleStep(0.05)
        ...
        self.spin_fw_live_max_gap.setSingleStep(0.1)
        self.spin_fw_live_max_gap.setDecimals(1)
        ...
        self.spin_fw_live_vad_max_speech_duration_s.setSingleStep(0.1)
        self.spin_fw_live_vad_max_speech_duration_s.setDecimals(1)
        ...
        self.spin_fw_live_length_penalty.setSingleStep(0.05)
        ...
        self.spin_fw_live_compression_ratio_threshold.setSingleStep(0.1)
        self.spin_fw_live_compression_ratio_threshold.setDecimals(1)
        ...
        self.spin_fw_live_logprob_threshold.setSingleStep(0.1)
        self.spin_fw_live_logprob_threshold.setDecimals(1)
    ...
    def _create_fw_file_params_tab(self) -> QWidget:
        ...
        self.spin_stt_pad_before.setSingleStep(0.05)
        ...
        self.spin_fw_file_max_gap.setSingleStep(0.1)
        self.spin_fw_file_max_gap.setDecimals(1)
        ...
        self.spin_fw_file_vad_max_speech_duration_s.setSingleStep(0.1)
        self.spin_fw_file_vad_max_speech_duration_s.setDecimals(1)
        ...
        self.spin_fw_file_length_penalty.setSingleStep(0.05)
        ...
        self.spin_fw_file_compression_ratio_threshold.setSingleStep(0.1)
        self.spin_fw_file_compression_ratio_threshold.setDecimals(1)
        ...
        self.spin_fw_file_logprob_threshold.setSingleStep(0.1)
        self.spin_fw_file_logprob_threshold.setDecimals(1)
        ...
        def on_ok():
            ...
            try:
                ...
                QMessageBox.critical(
                    dialog, i18n.tr("JSON 오류"), i18n.tr("JSON 파싱 실패:\n") + str(e)
                )
                return
            if not isinstance(obj, dict):
                QMessageBox.critical(
                    dialog,
                    i18n.tr("형식 오류"),
                    i18n.tr("JSON은 오브젝트({}) 형태여야 합니다."),
                )
                return

            # Store canonical JSON string
            self._current["faster_whisper_params"] = json.dumps(
