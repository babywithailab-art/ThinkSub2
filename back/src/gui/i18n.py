...
from PyQt6.QtCore import QCoreApplication, QTranslator, QSettings
from PyQt6.QtWidgets import QLabel, QPushButton, QCheckBox, QGroupBox
...
def apply_widget_translations(root) -> None:
    for widget in root.findChildren((QLabel, QPushButton, QCheckBox)):
        try:
